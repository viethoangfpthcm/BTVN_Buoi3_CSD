...
class RequestQueue {
    ...
    public RequestQueue(Node front, Node rear) {
        this.front = front;
        this.rear = rear;
    }
...
class MyStore {
    ...
    void f2() throws Exception {
        ...
        //You should write here appropriate statements to complete this function.
        //--------------------------------------------------------
        Fruit rq = RQueue.deQueue();
        Fruit rqFruit = FList.searchNode(rq.getType());
        if(rqFruit != null){
            if(rqFruit.getAmount() >= rq.getAmount()){
                rqFruit.setAmount(rqFruit.getAmount() - rq.getAmount());
            }
        }
        //---------------------------------------------------------
        ftraverse(f);
